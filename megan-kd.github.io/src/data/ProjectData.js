...
export const aboutMeData = <>
 <span style={paragraphStyle}>In my last position at KPMG I led and contributed to several UI projects as a full-stack developer for 2 years. On these projects I was involved at every step of the process from gathering requirements, collaborating with designers, implementing and testing frontend features and backend APIs, and writing scripts and working with infrastructure teams to deploy apps to production environments in Azure and AKS. What I enjoyed most was working with wonderful UI/UX designers and bring their vision to life, as well as continuously work with clients to build UIs that speak to their needs. </span>
 <span style={paragraphStyle}>While pursuing my degree, I worked at Intel for a year on a Software Validation team. I built scripts and tools in Python to help automate their Bluetooth Qualification CI testing processes. I was most excited about working with hardware for the first time and using sensors to gather real time data! This job exposed me to working with front-end technologies and allowed me to hone my skills on the backend!</span>
 <span style={paragraphStyle}>I graduated from Pacific University as a Computer Science major in 2021 where my instruction was largely based around C and C++. Because of my interest in computer networking, I capped off my education on a senior project with two other students to create and fully document a virtual network, routing protocol, and network visualization tool. Our goal was to make a comprehensive, open source project to help computer science students dive into learning about networking and use it as a foundation for their own projects.</span>
 <span style={paragraphStyle}>Throughout my education and industry experience, I have learned that my favorite part of software engineering is collaboration. I thrive best in roles where I am working with many different teams and solving interesting problems. Which is why I am drawn to full-stack development and computer networking.</span>
 <span style={paragraphStyle}>In my free time, I enjoy baking, reading horror novels, and playing Slay the Spire! You can find me hiking or playing PokemonGO outdoors if it’s not too hot and there’s not too many hills ( ‾́ ◡ ‾́ )</span>
</>;